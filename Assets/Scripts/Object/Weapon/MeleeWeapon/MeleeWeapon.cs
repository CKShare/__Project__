...
public class MeleeWeapon : Weapon
{
    ...
    public void Hit(GameObject target, int attackID, bool checkHit = true)
    {
        if (checkHit && IsTargetInRange(target))
        {
            ...
            if (sceneObj != null)
            {
                ...
                if (damageable != null)
                {
                    ...
                    if (hitReactive != null)
                    {
                        ...
                        if (hitPoint.HitNoise != null && hitPoint.NoiseDuration > 0F)
                            GameUtility.ShakeCamera(hitPoint.HitNoise, hitPoint.NoiseDuration);
                    }
                }
            }
        }
